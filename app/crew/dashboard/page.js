...
import { updateCrewProfile, subscribeToCrewProfile, subscribeToCrewBookings } from '@/lib/firestore';
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="bg-card border-b border-border">
          <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <p className="text-muted-foreground">Welcome back, {crew?.name || 'Crew Member'}</p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="p-6 bg-card border border-border rounded-lg">
              <h2 className="text-lg font-bold text-foreground mb-6">Availability Status</h2>
              <AvailabilityToggle
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="p-6 bg-card border border-border rounded-lg">
              ...
              <p className="text-4xl font-bold text-green-600 mt-2">{stats.accepted}</p>
            </div>
          </div>
